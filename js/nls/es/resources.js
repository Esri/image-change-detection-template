...
define({
  ...
  "imageMask": {
    ...
    "error8": "Rango de fechas no válido: la fecha de inicio debe ser anterior a la fecha de fin.",
  ...
  "coordinate": {
    ...
    "hintMessage": "Haga clic en el mapa para obtener coordenadas",
    ...
    "loading": "cargando...",
    "enableClick": "Haga clic para habilitar la obtención de coordenadas al hacer clic en el mapa",
    "disableClick": "Haga clic para deshabilitar la obtención de coordenadas al hacer clic en el mapa",
    "Default": "Predeterminado",
    "Inches": "Pulgadas",
    "Foot": "Pies",
    "Foot_US": "Feet_US",
